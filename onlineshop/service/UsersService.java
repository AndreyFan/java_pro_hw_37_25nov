...
public class UsersService {
    ...
    public UserDto updateUsers(UserDto updUserDto) { //update
        UsersEntity createUserEntity = new UsersEntity(updUserDto.getUserID(), updUserDto.getName(), updUserDto.getEmail(), updUserDto.getPhoneNumber(), updUserDto.getPasswordHash(), null);
